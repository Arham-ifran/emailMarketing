...
class AddFeilds2ToSmsCampaignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('sms_campaigns', function (Blueprint $table) {
            ...
            $table->timestamp('schedule_date')->comment('Schedule Once if set')->nullable()->after("type");
            ...
            $table->tinyInteger('day_of_month')->comment('monthly & yearly recursive option')->nullable()->after("day_of_week");
            ...
            $table->tinyInteger('no_of_time')->comment('weekly / monthly / yearly')->nullable()->after("month_of_year");
