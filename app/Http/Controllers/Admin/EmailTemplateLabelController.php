...
use App\Models\Admin\EmailTemplateLabel;
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $datatable = $datatable->addColumn('action', function ($row) {
                ...
                if (have_right(93)) {
                    $actions .= '&nbsp;<form id="delete_'.Hashids::encode($row->id).'" method="POST" action="' . url("admin/email-template-labels/" . Hashids::encode($row->id)) . '" accept-charset="UTF-8" style="display:inline">';
