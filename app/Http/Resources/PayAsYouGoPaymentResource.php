...
class PayAsYouGoPaymentResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'total_amount' => $this->total_amount_charged,
            ...
            'link' => $this->link,
            'charging_for_emails' => $this->charging_for_emails,
            'charging_for_sms' => $this->charging_for_sms,
            'charging_for_contacts' => $this->charging_for_contacts,
            'price_for_emails_charged' => $this->price_for_emails_charged,
            'price_for_sms_charged' => $this->price_for_sms_charged,
            'price_for_contacts_charged' => $this->price_for_contacts_charged,
        ];
    }
}
