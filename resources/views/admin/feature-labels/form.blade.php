...
@section('sub-title', $action. ' Feature Labels')
@section('content')
<div class="main-content">
	<div class="content-heading clearfix">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{url('admin/feature-labels')}}"><i class="fa fa-list"></i> Feature Labels</a>
			</li>
			<li>{{$action}}</li>
		</ul>
	</div>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">{{$action}} Feature Label</h3>
					</div>
					<div class="panel-body">
						@include('admin.messages')
						<form id="feature-label-form" class="form-horizontal label-left" action="{{url('admin/feature-labels')}}" enctype="multipart/form-data" method="POST">
							@csrf
							...
							<div class="form-group">
								<label for="feature_id" class="col-sm-3 control-label">Features<span class="text-red">*</span></label>
								<div class="col-sm-9">
									<select class="form-control" name="feature_id" id="" required>
										<option value="">Select Feature</option>
										@foreach($features as $feature)
										@php $selected = ($action == 'Edit' && $feature->id == $model->feature_id) ? 'selected' : ''; @endphp
