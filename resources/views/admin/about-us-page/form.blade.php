...
<div class="main-content">
	<div class="content-heading clearfix">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{url('admin/about-us-page')}}"><i class="fa fa-server"></i> About Us</a></li>
			<li>{{$action}}</li>
		</ul>
	</div>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel">
					...
					<div class="panel-body">
						...
						<form id="about-us-page-form" class="form-horizontal label-left" action="{{url('admin/about-us-page')}}" enctype="multipart/form-data" method="POST">
							@csrf
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<div style="width: 255px; height: auto">
										<img src="{{checkImage(asset('storage/about-us-page/' . $model->image),'placeholder.png')}}" class="img-responsive" alt="" id="image">
									</div>
								</div>
							</div>

							@if(checkImage(asset('storage/about-us-page/' . $model->image),'placeholder.png') != 'placeholder.png' && checkImage(asset('storage/about-us-page/' . $model->image),'placeholder.png') != NULL && $model->image != NULL)
							<div class="form-group">
