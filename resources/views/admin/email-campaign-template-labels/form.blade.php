...
<div class="main-content">
	<div class="content-heading clearfix">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{url('admin/email-campaign-template-labels')}}"><i class="fa fa-list"></i> Email Template
					Labels</a>
			</li>
			<li>{{$action}}</li>
		</ul>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel">
					...
					<div class="panel-body">
						...
						<form id="email-template-label-form" class="form-horizontal label-left" action="{{url('admin/email-campaign-template-labels')}}" enctype="multipart/form-data" method="POST">
							@csrf
							...
							<div class="form-group">
								<label for="email_campaign_template_id" class="col-sm-3 control-label">Email Templates<span class="text-red">*</span></label>
								<div class="col-sm-9">
									<select class="form-control" name="email_campaign_template_id" id="" required>
										<option value="">Select Email Template</option>
										@foreach($email_templates as $email_template)
										@php $selected = ($action == 'Edit' && $email_template->id ==
										$model->email_campaign_template_id)
										? 'selected' : ''; @endphp
							...
							<div class="text-right">
								<a href="{{url('admin/email-campaign-template-labels')}}">
