...
@section('sub-title', $action. ' Service Labels')
@section('content')
<div class="main-content">
	<div class="content-heading clearfix">
		...
		<ul class="breadcrumb">
			...
			<li><a href="{{url('admin/service-labels')}}"><i class="fa fa-list"></i> Service Labels</a>
			</li>
			<li>{{$action}}</li>
		</ul>
	</div>
			...
			<div class="col-md-8 col-md-offset-2">
				<div class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">{{$action}} Service Label</h3>
					</div>
					<div class="panel-body">
						@include('admin.messages')
						<form id="service-label-form" class="form-horizontal label-left" action="{{url('admin/service-labels')}}" enctype="multipart/form-data" method="POST">
							@csrf
							...
							<div class="form-group">
								<label for="service_id" class="col-sm-3 control-label">Services<span class="text-red">*</span></label>
								<div class="col-sm-9">
									<select class="form-control" name="service_id" id="" required>
										<option value="">Select Service</option>
										@foreach($services as $service)
										@php $selected = ($action == 'Edit' && $service->id == $model->service_id) ? 'selected' : ''; @endphp
