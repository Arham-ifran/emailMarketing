...
<body style="width: 100%;margin: 0 auto;color: #0010289c;background: #FFFFFF;font-size: 12px;">
    ...
    <div style="text-align: left; font-size:16px; display:block; width: 100%; margin-bottom: 15px;">
        <div style="width: 50%; float:left;"><b>Initiated at:</b> {{$data['initiated_at']}}</div>
        <div style="width: 50%; float:right;"><b>Processed at:</b> {{$data['processed_at']}} </div>
    </div>
    ...
    <div class="row">
        ...
        @php
        $contacts = [];
        $contacts = array_merge($contacts, $report->sent_to->toArray());
        @endphp
        ...
        <table id="example1" style="width: 100%;border-collapse: collapse;border-spacing: 0;margin-bottom: 20px;">
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center" style="font-size:14px;text-align:left;padding:8px 10px;border:solid #c7c7c7;border-width:0 1px 1px 1px;vertical-align:top;font-weight:bold;">Contact Report Link</td>
                    <td width="15%" class="text-center" style="font-size:14px;text-align:left;padding:8px 10px;border:solid #c7c7c7;border-width:0 1px 1px 1px;vertical-align:top;">{{url('/api/campaign-contacts-report')}}/{{ \Hashids::encode($report->id) }}</td>
                </tr>
