    ...
    <div style="width: 1000px; margin:0 auto; background:#fff; color:#000;font-family: {{$global_font_family}}, 'Segoe UI', 'sans-serif';">
        <table style="width: 1000px;margin: 0px 0 50px;font-family: {{$global_font_family}}, 'Segoe UI', 'sans-serif';">
            <tr style="vertical-align:top; font-family: {{$global_font_family}}, 'Segoe UI', 'sans-serif';">
                ...
                <td style="width: 500px; text-align: right;vertical-align:middle; font-family: {{$global_font_family}}, 'Segoe UI', 'sans-serif';">
                    <!-- <img src="{{asset('images/admin-login-logo.png')}}" alt="" width="300px"> -->
                    <img src="https://www.timmunity.com/storage/uploads/site_logo.png" alt="" >
                </td>
            </tr>
            <tr style="vertical-align:top; font-family: {{$global_font_family}}, 'Segoe UI', 'sans-serif';">
                                        ...
                                        <tr>
                                            <td style="padding-top: 20px;font-family: {{$global_font_family}}, 'Segoe UI', 'sans-serif';">
                                                <span style="text-align: left;white-space: nowrap;font-size: 14px;font-family: {{$global_font_family}}, 'Segoe UI', 'sans-serif';">
                                                    ...
                                                    if($item['repetition'] > 1 || $item['payment_method'] == 'admin')
                                                    {
                                                    if($item['type'] == 1){
                                                    echo translateText($lang,'Monthly').' '.translateText($lang,'for').' '.$item['repetition'].' '. translateText($lang,'month').'(s)';
                                                    }else{
                                                    echo translateText($lang,'annually').' '.translateText($lang,'for').'
                                                    '.$item['repetition'].' '. translateText($lang,'year').'(s)';
                                                    }
                                                    }else if($item['type'] == 1)
                                                    {
                                                    echo translateText($lang,'Monthly');
                                                    }else{
                                                    echo translateText($lang,'annually');
                                                    }
