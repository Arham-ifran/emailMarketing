...
const Newreport = (props) => {
    ...
    const getReport = (campId) => {
        setPageLoading(true);
        axios
            .get("/api/get-sms-campaign-report-histories/" + campId + "?page=" + pageNumber + "&lang=" + localStorage.lang)
            .then((response) => {
                ...
                <section className="reports">
                    <div className="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between ml-3">
                        <div className="page-title">
                            <h2>{t('Campaign Name')}: <span className="muted"> {campaign.name} </span> </h2>
                        </div>
                    </div>
                    <Container fluid>
                        <Row>
                            ...
                            <Col xl="4" lg="6" md="4" sm="6" xs="12">
                                <div className="stat-box bg-white rounded-box-shadow d-flex flex-column align-items-center">
                                    <span className="title">{t('Times Sent')}</span>
