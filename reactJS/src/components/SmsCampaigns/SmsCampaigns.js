				...
				<Container fluid>
					<div className="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between mb-3">
						...
						<div className="create-campaign">
							<Link to="/create-sms-campaign" className="btn btn-secondary">
									...
									<tr>
										...
										<td>
											<ul className="action-icons list-unstyled">
												<li><Link to="/sms-campaigns/:campaignId" className="view-icon" title="View"><FontAwesomeIcon icon={faEye} /></Link></li>
												<li><Link to="/sms-campaigns/:campaignId" className="edit-icon" title="Edit"><FontAwesomeIcon icon={faPencilAlt } /></Link></li>
